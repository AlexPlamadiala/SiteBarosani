        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8 mb-8">
          ...
          <div className="text-center md:text-left">
            ...
            <nav className="space-y-2">
              <Link
                to="/"
                className="block text-sm text-gray-300 hover:text-[#D4AF37] transition-colors"
              >
                🏠 Acasă
              </Link>
              <Link
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start gap-3 mb-4">
              ...
              >
                ...
                <div className="relative w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-white/20 transition-all group-hover:scale-110">
                  <svg className="w-4 h-4 text-gray-300 group-hover:text-[#D4AF37] transition-colors" fill="currentColor" viewBox="0 0 24 24">
